...
namespace FlashcardTests
{
    ...
    public class CardsControllerTests
    {
        ...
        public CardsControllerTests()
        {
            ...
            flashcardDbContextMock.Setup(x => x.SaveChangesAsync()).ReturnsAsync(1);
            //flashcardDbContextMock.Verify(x => x.SaveChangesAsync());
        }
        ...
        public async Task GetCards_ReturnsAllCards()
        {
            ...
            // Asssert
            var cards = Xunit.Assert.IsType<List<CardDTO>>(result.Value);
        ...
        {
            // Arrange
            var mock = new Mock<IFlashcardDbContext>();
            ...
            // Asssert
            Assert.NotNull(resultCard.Value.Question_sound);
        }
